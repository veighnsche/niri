...
> **Risk Level**: 🟢 Low  
> **Prerequisite**: Phases P1-P7.5 complete (P8 skipped)
...
- [ ] All 7 subsystems compile and work
- [ ] `Niri` struct has < 50 fields (down from 195)
...
│  │  └─────────────┘  └─────────────┘  └─────────────┘           ││
│  │  ┌─────────────┐  ┌─────────────┐  ┌─────────────┐           ││
│  │  │StreamingSub │  │ UiOverlays  │  │InputTracking│           ││
│  │  │ - casts     │  │ - screenshot│  │ - gestures  │           ││
│  │  │ - pipewire  │  │ - hotkey    │  │ - wheel     │           ││
│  │  │ - mapped    │  │ - exit      │  │ - mods      │           ││
│  │  └─────────────┘  └─────────────┘  └─────────────┘           ││
│  │  ┌─────────────┐  ┌───────────────────────────────────────┐  ││
│  │  │ProtocolStat │  │               Layout                  │  ││
│  │  │ - xdg_shell │  │       (already its own module)        │  ││
│  │  │ - layer     │  │                                       │  ││
│  │  │ - seat      │  │                                       │  ││
│  │  └─────────────┘  └───────────────────────────────────────┘  ││
│  └───────────────────────────────────────────────────────────────┘│
